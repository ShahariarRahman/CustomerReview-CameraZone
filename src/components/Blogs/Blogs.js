            ...
            <div>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li>Context API export variables that can be accessable in all levels in child.</li>
                        ...
                        <li>Context api is very helpfull when we share data in a nested componenet.</li>
                    </ul>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p className='font-semibold'>Answer:</p>
                    <ul>
                        <li>Inline: Element doesn't start on a new line.It takes width as much as it required.</li>
                        ...
                        <li>Inline-block: ELement doesn't start on a new line. It takes width as much as it required.</li>
